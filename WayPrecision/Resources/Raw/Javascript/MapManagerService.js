    ...
    let iniciarPantalla = function (idLastLayer, isDevelop, idProyecto)
    {
        ...
        buttonNavigation = L.easyButton({
            states: [{
                ...
                icon: '<img width="32" src="https://cdn.jsdelivr.net/gh/jpatinocollado/uoc-tfg-wayprecision@0.0.14/WayPrecision/Resources/Images/localizacion132x32.png" />',
                ...
                icon: '<img width="32" src="https://cdn.jsdelivr.net/gh/jpatinocollado/uoc-tfg-wayprecision@0.0.14/WayPrecision/Resources/Images/localizacion232x32.png" />',
                ...
                icon: '<img width="32" src="https://cdn.jsdelivr.net/gh/jpatinocollado/uoc-tfg-wayprecision@0.0.14/WayPrecision/Resources/Images/localizacion332x32.png" />',
